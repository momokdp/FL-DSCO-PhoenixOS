...
const DICT = {
  en: {
    ...
    'mission.alreadyDelivered': '{v} already delivered',
    ...
    'board.payoutNote': 'Shares are settled on the first of next month, in proportion to merit points.',
    'board.pool': 'Pot to share',
    'board.shareLabel': "Pilots' share",
    'board.shareSaved': "Pilots' share updated.",
    'board.shareExplain': "A pilot's percentage is their share of those points; applied to the pot, it gives what they will be paid.",
    'board.payoutTitle': 'Estimate for the end of the month, from the funds logged right now.',
    'board.pieAlt': "Each pilot's share of the period's runs",
    'board.pieShares': 'participation',
  ...
  fr: {
    ...
    'mission.alreadyDelivered': '{v} déjà livrés',
    ...
    'board.payoutNote': 'La répartition se fait le premier du mois suivant, au prorata des points de mérite.',
    'board.pool': 'Cagnotte à répartir',
    'board.shareLabel': 'Part reversée',
    'board.shareSaved': 'Part reversée mise à jour.',
    'board.shareExplain': "Le pourcentage d'un pilote est sa part de ces points ; appliqué à la cagnotte, il donne ce qu'il touchera.",
    'board.payoutTitle': "Estimation pour la fin du mois, d'après les fonds relevés à l'instant.",
    'board.pieAlt': 'Part de chaque pilote dans les runs de la période',
    'board.pieShares': 'participation',
